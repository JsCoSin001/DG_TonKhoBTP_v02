...
{
    public partial class ThietLap_KH : UserControl
    {
        ...
        private void TinhKLConLai(object sender, EventArgs e)
        {
            ...
            if (result >= 0)
            {
                tbHangDat.Value =  result;
                return;
            }
            FrmWaiting.ShowGifAlert("Dữ liệu không hợp lệ");
        ...
        private void ThietLap_KH_Load(object sender, EventArgs e)
        {
            ResetForm();
        }
